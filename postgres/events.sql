...
(
    ...
    event_date character varying(50) COLLATE pg_catalog."default",
    event_date_culture_info character varying(10) COLLATE pg_catalog."default",
    event_description character varying(255) COLLATE pg_catalog."default",
    proposal_reminded boolean NOT NULL,
    previously_reminded boolean NOT NULL,
