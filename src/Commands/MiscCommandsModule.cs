    ...
    class MiscCommandsModule : BaseCommandModule
    {
        ...
        public async Task AboutAsync(CommandContext ctx)
        {
            ...
            var embedBuilder = new DiscordEmbedBuilder
            {
                ...
                $"\n\n{Formatter.MaskedUrl("Add me to your server!", new Uri("https://discord.com/api/oauth2/authorize?client_id=382165423979888653&permissions=8&scope=bot+applications.commands"))}"),
